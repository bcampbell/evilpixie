...
void LoadPNG( IndexedImg& img, RGBx* palette, const char* filename )
{
...
void SavePNG( IndexedImg const& img, RGBx const* palette, const char* filename )
{
